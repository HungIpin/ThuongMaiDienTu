...
namespace QuanLyBanGiayASP.Areas.Customer.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        {
            //lấy hết tất cả sản phẩm đã đặt
        ...
        //Tạo 1 bảng customer riêng lúc từ view đổ sang controler tạo 1 view model chứa customer và 1 list Product
        [HttpPost]
        ...
        public IActionResult IndexPost()
        {
            ...
            orders.CustomerPersonId = userid;
